...
<html lang="en">
  ...
  <?php include('header.php'); ?>
           <section> 
             ...
             <h1 style="text-align:center; font-size:25px; color: antiquewhite;">Admin Login</h1><br>
                    <form name="login" action="" method="post">
                       <div class="login">
                        <input type="text" name="username" placeholder="Username" required=""> <br><br>
                        <input type="password" name="password" placeholder="Password" required=""><br><br>
                         <input type="submit" name="submit" class="btn btn-danger" value="Login" style="height:40px;"></div>
                    </form>
                    <p style="color: white ; padding-left:30px";><br><br>
                    <a style="color:yellow" href="updatepass.php">Forgot Password?</a> &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp; New to this Website?<a style="color: yellow;" href="registration.php">Sign Up</a>
                    </p>
