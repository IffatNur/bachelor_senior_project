...
<div class="container">
   <div class="srch">
    ...
    <h3 style="text-align:center;"><b><u>Request of Book</u></b></h3>
<?php
    if(isset($_SESSION['login_user']))
    {
        $sql="SELECT student.username,id,books.bid,name,authors,edition,status FROM student inner join issue_book ON student.username=issue_book.username inner join books ON issue_book.bid=books.bid WHERE issue_book.approve ='' ";
