   ...
   <div class="nav1">
      ...
      <?php
           ...
           {?>
                <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="studentlogin.php"><img src="login.png" height="25px"> Login</a>
      </li>
   ...
   <div class="logo">
             ...
             <h1 style="text-align:center; font-size:25px; color: antiquewhite;">User Registration Form</h1><br>
                    <form name="Registration" action="" method="post">
                       ...
                       <input type="text" name="last" placeholder="Last Name" required=""><br><br>
                        ...
                        <input type="text" name="id" placeholder="Id No" required=""><br><br>
      ...
      if(isset($_POST['submit']))
      {
          ...
          while($row=mysqli_fetch_assoc($res))
          {
              ...
              {mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[id]', '$_POST[email]', '$_POST[contact]');");
        ?>
