    ...
    <?php 
     ...
     if(isset($_POST['done'])){
      ...
      $email = $_POST['email'];
          ...
          if(empty($_POST['id']) ||  empty($_POST['username']) || empty($_POST['advisor']) || empty($_POST['dept'])
          ||  empty($_POST['semester']) || empty($_POST['email']))
          {
          }
          else{
              $password = rand(22222,99999);
            $sql = "INSERT INTO `ciu` . `student` (id,username,first,last,password,advisor, dept,semester,email,contact ) 
                VALUES ('$id','$name','$first','$last','$password','$advisor','$dept','$semester','$email','$contact')";
                ...
                try {
                    ...
                    $mail->addAddress($email, 'Fahim Hasan');     //Add a recipient
    ...
    <div id="main">
        ...
        <div class="row" style="margin:20px;font-size:15px;">
            <form method="POST" style="text-align:left;width: 400px;background:lightblue">
                <h5>Please Insert Student ID</h5>
                <input style="width: 380px;margin-top:10px" type="text" id="id" name="id" required>

                <h5 style="margin: 10px 0 0 0"> Please Insert Student User Name </h5>
                <input style="width: 380px;margin-top:10px" type="text" id="name" name="username" required>
                <h5 style="margin: 10px 0 0 0"> Please Insert Student Full Name </h5>
                <input style="width: 380px;margin-top:10px" type="text" id="name" name="first" placeholder="First Name"
                    required>
                <input style="width: 380px;margin-top:10px" type="text" id="name" name="last" placeholder="Last Name"
                    required>
                <h5> Please Select Advisor</h5>
                <select name="advisor" id="advisor" style="padding: 0 100px 0 35px">
                ...
                <h5>Please Select Semester</h5>
                <input type="radio" id="semester" name="semester" value="AUTUMN" required>
                <label for="">AUTUMN</label><br>
                <input type="radio" id="semester" name="semester" value="SPRING" required>
                <label for="">SPRING</label><br>
                <input type="radio" id="semester" name="semester" value="SUMMER" required>
                <label for="">SUMMER</label><br><br>

                <h5 style="margin: 10px 0 0 0"> Please Insert Student Email </h5>
                <input style="width: 380px;margin-top:10px" type="text" id="email" name="email" required><br><br>

                <h5 style="margin: 10px 0 0 0"> Please Insert Student Contact </h5>
                <input style="width: 380px;margin-top:10px" type="number" id="email" name="contact" required><br><br>
