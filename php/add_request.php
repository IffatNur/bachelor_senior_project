...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item" style="padding-left: 5px; padding-right: 5px;">
                        <a class="nav-link active" href=".php"><b>DROP REQUEST</b></a>
                    </li>
                    <li class="nav-item" style="padding-left: 5px; padding-right: 5px;">
        ...
        <form action="" method="POST">
            ...
            <div style=" text-align:center;border-style: dashed;border-color: black;margin-bottom:10px">
                ...
                <select name="reason" id="reason" style="padding: 0 100px 0 35px">
                    ...
                    <option value="My friends are in this course ">My friends are in this course</option>
                    <option value="Time clash">Time clash</option>
                    <option value="Less credit">Less credit</option>
    ...
    $query = mysqli_query($con, $q);
     ...
     while($res = mysqli_fetch_array($query)){
        ...
        if($num == 1){
            $sql = "INSERT INTO `ciu` . `add_request` (sid,name,reason,payment,course,credit,bill,day,time)
            VALUES ('$sid','$name','$reason','$payment','$course','$credit','$bill','$day',current_timestamp()) ";
