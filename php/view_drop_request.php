 ...
 <body>
             ...
             <div class="collapse navbar-collapse" id="navbarSupportedContent">
                 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                     ...
                     <li class="nav-item" style="padding-left: 5px; padding-right: 5px;">
                         <a class="nav-link active" href="view_add_request.php"><b>ADD REQUEST</b></a>
                     </li>
                     <li class="nav-item" style="padding-left: 5px; padding-right: 5px;">
     ...
     <div class="" style="">
        ...
        if(isset($_GET['search'])){
             ...
             $qry = "SELECT * FROM drop_request WHERE CONCAT(sid,name) LIKE '%$searchfilters%'";
            ...
            $sid= @$_GET['sid'];
            $r = " DELETE FROM `advising` WHERE `sid` = $sid";
            mysqli_query($con, $r);

            $q = "SELECT * FROM `drop_request`";
             ...
             <tr>
                 ...
                 <td>
                     <button type=" submit" name="submit" class=" btn">
                         <a href="view_drop_request.php?sid=<?php echo $res['sid'];?>" class="text-danger">
                             <i class="fa fa-trash" aria-hidden="true" style="font-size:25px"></i></a>
                     </button>
                 </td>
